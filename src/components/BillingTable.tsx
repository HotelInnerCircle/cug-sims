  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="px-5 py-4 bg-white border shadow-sm border-slate-200 rounded-2xl">
          <p className="mb-1 text-xs font-semibold tracking-wider uppercase text-slate-500">Total Connections</p>
          <p className="text-2xl font-bold text-slate-800">{data.length}</p>
        </div>
        <div className="px-5 py-4 bg-white border shadow-sm border-emerald-200 rounded-2xl">
          <p className="mb-1 text-xs font-semibold tracking-wider uppercase text-emerald-600">Active Plans</p>
          <p className="text-2xl font-bold text-emerald-700">{summaryStats.active}</p>
        </div>
        <div className="px-5 py-4 bg-white border shadow-sm border-amber-200 rounded-2xl">
          <p className="mb-1 text-xs font-semibold tracking-wider uppercase text-amber-600">Expiring Soon</p>
          <p className="text-2xl font-bold text-amber-700">{summaryStats.expiring}</p>
        </div>
        <div className="px-5 py-4 bg-white border border-red-200 shadow-sm rounded-2xl">
          <p className="mb-1 text-xs font-semibold tracking-wider text-red-600 uppercase">Expired</p>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white transition-colors shadow-sm rounded-xl bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white transition-colors bg-indigo-600 shadow-sm rounded-xl hover:bg-indigo-700 disabled:opacity-50"
        >
            ...
            <tbody className="divide-y divide-slate-100">
              {slice.length === 0 ? (
                ...
                slice.map((conn, i) => {
                  ...
                  return (
                    <tr key={conn._id ?? conn.mobile} className="transition-all duration-200 group hover:bg-blue-50/60">
                      {/* # */}
                      <td className="px-5 py-4 font-mono text-xs text-slate-400">{rowNum}</td>
